...
const paths = safeLoad(readFileSync(join(configPath, '../webpacker.yml'), 'utf8'))[env.NODE_ENV]
...
const publicPath = (env.NODE_ENV !== 'production' && env.NODE_ENV !== 'staging') && devServer.enabled ? devServerUrl : publicUrl
